...
- name: BOARD_InitPeripherals
  UUID: 5c8d4fd8-b652-4c57-a84a-5fb958af7982
  called_from_default_init: true
  selectedCore: core0
- name: BOARD_InitButtonsPeripheral
  UUID: 32743c03-b7aa-472b-8028-aa8d54d0ce96
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitLEDsPeripheral
  UUID: 9017567b-0d7d-4dd2-a6b5-97dcc49f0440
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitACCELPeripheral
  UUID: 2353ca3d-9f6e-4611-96ca-82abbe01d2ab
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitMAGPeripheral
  UUID: ad2c82af-7839-441c-b08b-9b08977affad
  selectedCore: core0
- name: BOARD_InitDEBUG_UARTPeripheral
  UUID: 97ba2346-71ac-4946-8e2d-4da46604d7ed
  id_prefix: BOARD_
  selectedCore: core0
